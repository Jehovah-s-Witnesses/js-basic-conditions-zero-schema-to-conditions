...
const proMonthSubscriptionNote =
  'Pro version - Basic + Personal support - 20$ month';
const premiumMonthSubscriptionNote =
  'Premium - Pro + Personal assistant - 50$ month.';
const basicYearSubscriptionNote =
  'You select 5$ in month. Only today you can create subscription on year an save 20$. Your amount was 40$.';
const proYearSubscriptionNote =
  'Your select 20$ in month.Only today you can create subscription on year an save 40$. Your amount was 200$.';
const premiumYearSubscriptionNote =
  'Your select 50$ in month.Only today you can create subscription on year an save 100$. Your amount was 500$.';
...
if (isNeedSubscription) {
  ...
  alert(
    `1.${basicMonthSubscriptionNote} 2.${proMonthSubscriptionNote} 3.${premiumMonthSubscriptionNote}`,
  );
